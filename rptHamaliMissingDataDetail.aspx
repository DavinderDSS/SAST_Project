<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptHamaliMissingDataDetail.aspx.vb" Inherits="rptHamaliMissingDataDetail" %>
...
<%--''This code is used to cover the CSP Policy not implemented point (GIS / VAPT 2021 suggested) added this on 03-12-2021--%>
	...
	<%--''This code is used to cover the Referer Policy not implemented point (GIS / VAPT 2021 suggested) added this on 15-12-2021--%>
    <title>Hamali Missing Data Detail</title>
<style type="text/css">
        .Gridview
        {
        font-family:Verdana;
                                                         ...
                                                         if (Diff[1]=='')
                                                        ...
                                                        else
                                                            {
                                                             ...
                                                             ReportWindow = window.open("", "subWind","toolbar=no,addressbar=no,resizable,scrollbars,modal=yes");
                                                               ...
                                                               var MissingTypeNm = document.getElementById("cmbMissingType");
                                                               var strMissingType = MissingTypeNm.options[MissingTypeNm.selectedIndex].text;
                                                               
                                                               ReportWindow.bgColor='steelblue';                                                               
                                                               ReportWindow.document.write('<h5>Hamali Missing Entry Data Details :  Period:Fm  '+ document.getElementById("txtFrom").value + ' To ' + document.getElementById("txtTo").value +' <br /> </h5>')
                                                               ReportWindow.document.write('<h5>Plant Detail:    '+ strPlant + '</h5>')
                                                               ReportWindow.document.write('<h5>Missing Type Detail:    '+ strMissingType + '</h5>')                                                                                                                             
                     ...
                     if (Page_ClientValidate())
                        {
                              ...
                              var FromDate = document.getElementById("txtFrom").value;
                                    ...
                                    var MissingType = document.getElementById("cmbMissingType").value; 
                                    
                                    Para=Para + "|" + "'" + MissingType + "'"; 
...
<tr><td align="center" style="height: 53px"><h3><u>HAMALI MISSING ENTRY DATA DETAIL REPORT</u></h3></td></tr>
</table>
   ...
   <center>           
            <div class="demo">
                            <table width="80%" id="MyTable" border="1">
                                    ...
                                    <td align="left" style="width: 125px">
                                    <label for="to" style="font-size:larger">Missing Type</label> &nbsp;
                                    </td>
                                    <td align="left">
                                    <asp:DropDownList ID="cmbMissingType" runat="server">   <%--Width="50%"--%>
			                        <asp:ListItem Value="0">Select</asp:ListItem>
			                        <asp:ListItem Value="Matnr">Matnr</asp:ListItem>
			                        <asp:ListItem Value="Location">Location</asp:ListItem>
			                        <asp:ListItem Value="Distance_Range">Distance Range</asp:ListItem>
			                        </asp:DropDownList>
			                        <asp:RequiredFieldValidator ID="ReqcmbMissingType" runat="server" SetFocusOnError="true" ErrorMessage="Select Missing Type " ControlToValidate="cmbMissingType" InitialValue="0"></asp:RequiredFieldValidator>                                                            
                                    </td>
