<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAssignRole.aspx.vb" Inherits="frmAssignRole" %>
...
//         Qry="Update UserMaster SET empmailid='"+ReadTextValues('txtEmpMailId')+"',EmpRptId='"+ReadComboValues('cmbReportingTo')+"',EmpRMailId='"+ReadTextValues('txtRMailId')+"',EmpCmplntLevel="+ReadComboValues('cmbRole')+",EmpName='"+ReadTextValues('txtEmpName')+"' Where EmpStaffId='" + ReadComboValues('cmbEmpCode')+"'; Update CustComplaintAutoMail SET GroupName='" + ReadComboValues('cmbGroup') + "',EmpCmplntLevel="+ReadComboValues('cmbRole')+",TrDate='"+ HiddenField1 +"' Where EmpStaffId='" + ReadComboValues('cmbEmpCode')+"'"
         Qry="Update Hamali_User_Master SET emp_mailid='"+ReadTextValues('txtEmpMailId')+"',Emp_role='"+ReadComboValues('cmbRole')+"',user_initial='"+ReadTextValues('txtEmpName')+"',emp_PlantNm='"+ReadTextValues('txtEmpLocn')+"' Where Emp_StaffId='" + ReadComboValues('cmbEmpCode')+"'"
        ...
        switch(Diff[0])
        	{
        		case "cmbEmpCode":
				                   ...
				                   document.getElementById("cmbRole").value=ValueTextArray[4]
...
<tr><td align="center" style="height: 53px"><h3><u>HAMALI ROLE ASSIGN DETAILS / UPDATION FORM</u></h3></td></tr>
</table>
    ...
    <tr><td align="right" style="width: 50%" >
        ReportingTo off. mail-ID :-</td><td align="left" style="width: 50%">
            ...
            <asp:RequiredFieldValidator ID="reqRepMailID" runat="server" ControlToValidate="txtRMailId"
                ErrorMessage="(Required)" Display="Dynamic"></asp:RequiredFieldValidator></td></tr>--%>     
    <tr><td align="right" style="width: 20%; font-size:larger" >
        Emp Role :-</td><td align="left" style="width: 50%">
            <asp:DropDownList ID="cmbRole" runat="server" CssClass="MyText">
                <asp:ListItem Value="0">No-Role</asp:ListItem>
                <asp:ListItem Value="1">HEAD_OFFICER</asp:ListItem>
                <asp:ListItem Value="2">PLANTINCHARGE</asp:ListItem>
                <asp:ListItem Value="3">SUPERVISOR</asp:ListItem>
                <asp:ListItem Value="4">ADMIN</asp:ListItem>                
            </asp:DropDownList><span style="font-size:larger; font-family:Bookman Old Style;">(No-Role=0,HEAD_OFFICER=1,PLANTINCHARGE=2,SUPERVISOR=3,ADMIN=4)</span></td></tr> 
        ...
        Emp. Location :-</td><td align="left" style="width: 50%">
            <asp:TextBox ID="txtEmpLocn" runat="server" CssClass="MyText" Width="50%" ReadOnly="false" ></asp:TextBox></td></tr>            
