<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmHamaliRate.aspx.vb" Inherits="frmHamaliRate" %>
...
//this is old with using cmbW methode start here
...
////                    CallServer(para,"");
////}
//this is old with using cmbW methode end here
        ...
        switch(DiffVal)
        	{
                     ...
                     case "cmbContractor":
				                    ...
				                    //alert(Diff[1]);
				                    //var ValueTextArray = Diff[1].split(",");	                  
				                    ////----Code for split,remove and concatenate of array string				                    
				                    ////alert(ValueTextArray[0]);
				                    ////alert(ValueTextArray[1]);
				                    //var ValueTextArray1  = ValueTextArray[1].split("~");
				                    //var ValueTextArray2 = ValueTextArray[0]+','+ValueTextArray1[0];
				                    ////alert(ValueTextArray2);	
...
<tr><td align="center" style="height: 53px"><h3><u>HAMALI RATE MASTER FORM</u></h3></td></tr>
</table>
...
<form runat="server" id="formID" > 
	...
	<table id="MyTable" border="1"> 
		...
		<tr> 
			...
			<td><input type="text" name="in_firstName[]" onkeypress="return NumberOnly()" onblur="FillDataText(this);" tabindex="9" /></td>  <%--onblur="FillDataText(this);"--%>
