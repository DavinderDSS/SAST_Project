<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptHamaliApproveDisapprove.aspx.vb" Inherits="rptHamaliApproveDisapprove" %>
                                                         ...
                                                         if (Diff[1]=='')
                                                        ...
                                                        else
                                                            {
                                                             ...
                                                             ReportWindow = window.open("", "subWind","toolbar=no,addressbar=no,resizable,scrollbars,modal=yes");
                                                               ...
                                                               var str = StatusNm.options[StatusNm.selectedIndex].text;                                                              
                                                               ...
                                                               ReportWindow.document.write('<h5>Hamali Approve Disapprove Status Details : Count Period:Fm  '+ document.getElementById("txtFrom").value + ' To ' + document.getElementById("txtTo").value +' <br /> </h5>')
                                                               ReportWindow.document.write('<h5>Plant Detail:    '+ strPlant + '</h5>')
                                                               ReportWindow.document.write('<h5>Status Detail:    '+ str + '</h5>')                                                               
...
<tr><td align="center" style="height: 53px"><h3><u>HAMALI APPROVE DISAPPROVE STATUS DETAIL REPORT</u></h3></td></tr>
</table>
...
<center>        
 ...
 <div id="Div1" style="OVERFLOW: auto; WIDTH: 98%; HEIGHT: 150px"> 
