Imports System.IO
Partial Class frmUserInActivation
            ...
            Try
                ...
                Select Case s(0).ToString
                    Case "cmbEmpCode"
                        ...
                        Call GetDataByDr("select user_initial,emp_mailid,emp_fname,emp_lname,empstatus,emp_plantnm from hamali_user_master where emp_staffid='" & s(1).ToString() & "'")
                    ...
                    Case "DisplayMailID"
                        ...
                        Exit Sub
                    Case "SearchedData"
                        Call GetDataByDr("select emp_staffid,emp_staffid+' - '+User_initial as Emp  from Hamali_user_master where user_initial like '%" & s(1).ToString & "%' and empstatus='Active' and Flag='0' order by emp_staffid")
