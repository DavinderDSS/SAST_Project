<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptSectionActivityWiseHamaliDtl.aspx.vb" Inherits="rptSectionActivityWiseHamaliDtl" %>
...
<%--''This code is used to cover the CSP Policy not implemented point (GIS / VAPT 2021 suggested) added this on 03-12-2021--%>
	...
	<%--''This code is used to cover the Referer Policy not implemented point (GIS / VAPT 2021 suggested) added this on 15-12-2021--%>
    <title>Hamali Section Activity Wise Detail Report</title>
                                                         ...
                                                         if (Diff[1]=='')
                                                        ...
                                                        else
                                                            {
                                                             ...
                                                             ReportWindow = window.open("", "subWind","toolbar=no,addressbar=no,resizable,scrollbars,modal=yes");
                                                               ...
                                                               ReportWindow.document.write('<h5>Hamali Section Activity Wise Detail : Period:Fm  '+ document.getElementById("txtFrom").value + ' To ' + document.getElementById("txtTo").value +' <br /> </h5>')
...
<tr><td align="center" style="height: 53px"><h3><u>HAMALI SECTION ACTIVITY WISE DETAIL REPORT</u></h3></td></tr>
</table>
