...
Partial Class frmHamaliApprovalDHANORA
            ...
            If CSRFUK = Session("CSRFUKSIDNew") And AuthTokennDtl.ToString.Equals(Request.Cookies("AuthToken").Value) Then   ''This is for else actule live usage   '' Added And obj.AuthTokennDtl.ToString.Equals(Request.Cookies("AuthToken").Value) in  if on 23-12-2019 ''''Session("AuthToken").ToString.Equals(Request.Cookies("AuthToken").Value)  
                ...
                If Session("Role").ToString = "PlantOfficer" Or Session("Role").ToString = "Admin" Then   ''Role wise page Autherity option Added this Code on 08-11-2019
                    ...
                    If Not IsPostBack Then
                        ...
                        ''GetDataByQUERY("select emp_staffid,user_initial from hamali_user_master where emp_plantNm='" & Session("plantName") & "' and (emp_role='3' or emp_role='2')  and emp_staffid in( select supervisor_code from hamal_trans where plantcode='" & Session("plantCode") & "')", cmbSupervisor, "Location", "Location_Code")
                        ''code is end here
                        ...
                        If hdnRndNo.Value = Session("RandomNumber") Then ''// code is added on 12-05-2020 For Request Flooding Issue Start here using existing code too
                            ...
                            For J = 0 To AllData.Length - 1
                                ...
                                If AllData(J).ToString <> Nothing Then
                                    ...
                                    If IsValidInputText(ValDtl(21).ToString) = False Then ''Added this line on 06-01-2020 For GIS Input ValidationPoint  for Remark Filed
                                    ...
                                    Else  ''Added this line on 06-01-2020 else
                                        ...
                                        Else
                                            ...
                                            Queries = ("Update hamal_trans set location=" & ValDtl(7).ToString & ",bag_weight=" & ValDtl(9).ToString & ",loading=" & ValDtl(10).ToString & ",unloading=" & ValDtl(11).ToString & ",sorting=" & ValDtl(12).ToString & ",stiching=" & ValDtl(13).ToString & ",stacking=" & ValDtl(14).ToString & ",restacking=" & ValDtl(15).ToString & ",weighing=" & ValDtl(16).ToString & ",bundle_preparation=" & ValDtl(17).ToString & ",opening_feeding=" & ValDtl(18).ToString & ",loading_unloading=" & ValDtl(19).ToString & ",Varai=" & ValDtl(20).ToString & ",remark=" & ValDtl(21).ToString & ",approval='approve' where rowid=" & ValDtl(0).ToString & " and plantCode='" & HiddenFieldPC.Value & "' and supervisor_code='" & cmbSupervisor.SelectedValue.ToString & "'")
                                        End If
