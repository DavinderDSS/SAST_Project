<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmHamaliExecution.aspx.vb" Inherits="frmHamaliExecution" %>
...
<%--<script language="javascript" type="text/javascript">
       // This code is use to set date picker from current date and pastdate unavailable,This is for first row of table, added on 6-4-2013 if want pastdate active comment below code               
                ...
                $(function () {
                 ...
                 $('#in_dateF').datepicker({ dateFormat: 'yy-mm-dd',
                     minDate: new Date(currentYear, currentMonth, currentDate)
                 });
             });
                
     //This code is use to set date picker from current date and pastdate unavailable,This is for first row of table, added on 6-4-2013 end here uptill comment this while past date active
</script>--%>
        ...
        <script type="text/javascript" language="javascript"> 
			...
			$(document).ready(function(){				
				...
				$(".cloneTableRows").live('click', function(){
					...
					//$('#'+thisTableId + " tr:last td :input").val('');  //This Line is commented on 18-07-2013 for copeing textbox values 
					...
					var this_id = $(this).attr("id"); // current inputs id
						...
						if($(this).hasClass("hasDatepicker")){ // if the current input has the hasDatpicker class
							...
							$(this).removeClass('hasDatepicker'); // remove hasDatepicker class
							 ...
							 //This code is use to set date picker from current date and pastdate unavailable added on 6-4-2013 if want pastdate active comment below code
				                             //var date = new Date();
                                             //var currentMonth = date.getMonth();
                                             //var currentDate = date.getDate();
                                             //var currentYear = date.getFullYear();
                                        //This code is use to set date picker from current date and pastdate unavailable added on 6-4-2013 end here uptill comment this while past date active
...
<%-- 18-03-2011 code is ended here --%>
    ...
    <tr> 
			...
			<td><input type="text" name="in_date[]" class="my_date" readonly="readonly" /></td> 			  
			...
			<td><input type="text" name="in_firstName[]"  onkeypress="return NumberOnly()" maxlength="3" value="0" /></td>					 
			<td><input type="text" name="in_firstName[]"  onkeypress="return NumberOnly()" maxlength="3" value="0" /></td>
			<td><input type="text" name="in_firstName[]"  onkeypress="return NumberOnly()" maxlength="3" value="0"  /></td>
			<td><input type="text" name="in_firstName[]"  onkeypress="return NumberOnly()" maxlength="3" value="0"  /></td>
			<td><input type="text" name="in_firstName[]"  onkeypress="return NumberOnly()" maxlength="3" value="0"  /></td>
			...
			<td><input type="text" name="in_firstName[]"  onkeypress="return NumberOnly()" maxlength="3" value="0"  /></td>
			<td><input type="text" name="in_firstName[]"  onkeypress="return NumberOnly()" maxlength="3" value="0"  /></td>
			<td><input type="text" name="in_firstName[]"  value="0"   /></td>
		</tr>
