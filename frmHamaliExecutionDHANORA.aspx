<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmHamaliExecutionDHANORA.aspx.vb" Inherits="frmHamaliExecutionDHANORA" %>
...
<%--''This code is used to cover the CSP Policy not implemented point (GIS / VAPT 2021 suggested) added this on 03-12-2021--%>
    ...
    <title>HAMALI EXECUTION</title>
        ...
        <%--<link href="jsFiles/datepicker/datepicker3.css" rel="stylesheet" type="text/css" />--%>              
        <%--<link href="jsFiles/select2/select2.css" rel="stylesheet" type="text/css" />--%>                
       ...
       <!-- Below Code is added on 25-02-2019 For DropDown With Select Option--> 
       <%--<script language="javascript" type="text/javascript" src="jsFiles/jquery.min.js"></script>--%>
...
<script type="text/javascript" src="CloneDatepicker/FrmToDateLimit/js/1819jquery-ui.custom.min.js"></script>
       ...
       <%--<script language="javascript" type="text/javascript" src="jsFiles/datepicker/bootstrap-datepicker.js"></script>--%>
       <%--<script language="javascript" type="text/javascript" src="jsFiles/select2/select2.js"></script>--%>  
...
<%-- // This code is use to set date picker from current date and future date unavailable,This is for first row of table, added on 5-8-2013 if want furute date active comment below code--%>
        ...
        <script type="text/javascript" language="javascript"> 			
			$(document).ready(function(){
				...
				//alert("i am in Function Of Table");	
				//initDatepickersAndSelect(); //Added this on 25-02-2019
		...
		//<!-- TODO: cut,copy & paste options are disabled Added this  on 06-01-2020 as for password value issue -->
				...
				//debugger; //// This funcation is used to debugg Jquery Code at clicent side 
				//$(".selectType").select2();
				
				
				//---Select2
				//$(".js-example-placeholder-single").select2({ tags: true });
				//$(".responsibility").select2({ tags: true });
				...
				$(".cloneTableRows").live('click', function(){
					...
					//New code 05-04-2019
				//$('#'+thisTableId + " tr:last").children("select").select2("destroy");
					...
					// clone last row
					var newRow = lastRow.clone(true);   // UnCOmmente this on 26-05-2020 as Delete row function was not work and remove all Select2 features
                    
                    					//var newRow = lastRow.clone(false); // COmmente this on 26-05-2020
                ...
                // --- Select2
				//$(".form-control js-example-placeholder-single").select2({placeholder: "Select",allowClear: true});
...
function DistComboActive(ob)
            {
                    ...
                    var DataVal=Data.substring(13,30);
                        ...
                        //alert(Val);
                            ...
                            {
                            //alert("I am In else");
                            /////////$("#cmbDist"+DataVal).attr('readonly','readonly');
            ...
            //alert(DataVal);   
                ...
                //alert(Val);
                   ...
                   //below code is added on 30-8-2013 for entering specifice cell value on Bale-G.Bag and Bundle-G.Bag operation comment is error occue
                    ...
                    $("#LoadingUnloading"+DataVal).attr('disabled','disabled');
                    $("#Varai"+DataVal).attr('disabled','disabled');
                    }
                    
                    if(Val=='ha002')
                    {
                    $("#Loading"+DataVal).attr('disabled','disabled');
                    ...
                    $("#LoadingUnloading"+DataVal).attr('disabled',false);
                    $("#Varai"+DataVal).attr('disabled',false);
                    }
...
function TypeComboActive(ob)
            ...
            //below code is use to set values while MAtArt is Stoar 12-3-2013
//            var Val=$("#cmbMatArt"+DataVal).val();
//            //alert(Val);
//            if(Val=="VERP")
//            {
//            //$("#cmbKNV"+DataVal).attr('value','0');
//            $("#cmbT"+DataVal).attr('disabled','disabled');
//            $("#cmbT"+DataVal).attr('value','store');
//            $("#cmbKNV"+DataVal).attr('disabled','disabled');
//            $("#cmbKNV"+DataVal).attr('value','store');
//            }  
//            //code is end here 
//            if(Val!="VERP")
//            {
            $("#cmbT"+DataVal).attr('disabled',false);  //Add this line on 12-3-2013          
            $("#cmbT"+DataVal).attr('value','0');
            $("#cmbKNV"+DataVal).attr('disabled',false); //Add this line on 12-3-2013                       
            $("#cmbKNV"+DataVal).empty(); // This is used to clear the dropdown list,totaly blank
            
            
//            $("#cmbKNV"+DataVal).remove();//            $("#cmbKNV"+DataVal).attr('selectedIndex', '-1');
//            $('#cmbKNV option:eq(0)').attr('selected','selected');
//            //$("#cmbKNV"+DataVal).attr('value',' '); // This is used to make drop down list empty not totaly. 
//            //$("#cmbKNV"+DataVal).val('0');
//            }
                  ...
                  //para=para +"'"+ Supervisor +"'," +"'"+ PlantCd +"'," 
                    ...
                    $("table#tblHamaliExe").find("tr").not(':first').each ( function() 
                    {
                        ...
                        $(this).find("input[type=text],select").each(function(){
                                ...
                                var ans=$(this).is("select");
                                //alert(index);
                                if(index !="3")                     //$(this).attr("id")!='cmbMatArt'
                                    {                                                         
                                        if(ans=='true')
                                        {  
                                          para=para +"'" + $("#"+ $(this).attr("id")+"option:selected").val()+ "'," ;  //+  '|'
...
<%-- 18-03-2011 code is ended here --%>
    ...
    <tr> <%--class='template'--%>
			...
			<td><asp:DropDownList ID="cmbKNV" runat="server" CssClass="selectType" ToolTip="Select" >  <%-- class="responsibility" width="100px" class="select2" CssClass="form-control js-example-placeholder-single //select2-drop select2-with-searchbox select2-drop-active select2-display-none"   style="left: 0px; width: 300px; top: 917px; bottom: auto; display: block;" --%>
			<asp:ListItem Value="0">Select</asp:ListItem>
			...
			<td><input type="text" name="in_firstName[]"  onkeypress="return NumberOnly()" maxlength="3" style="width:50px" value="0"  id="LoadingUnloading"  /></td>
