<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmHamaliEntryDeletion.aspx.vb" Inherits="frmHamaliEntryDeletion" %>
...
<%--''This code is used to cover the CSP Policy not implemented point (GIS / VAPT 2021 suggested) added this on 03-12-2021--%>
	...
	<%--''This code is used to cover the Referer Policy not implemented point (GIS / VAPT 2021 suggested) added this on 15-12-2021--%>
    <title>HAMALI ENTRY DELETION FORM</title>
        ...
        switch(Diff[0])
        	{
				     ...
				     case "SaveData":
				                        ...
				                        window.location="frmHamaliEntryDeletion.aspx";
				                        break				                        
...
function btnSubmit_onclick(flag)
 {
                ...
                var Supervisor=$('#cmbSupervisor').find('option:selected').val();
                ...
                function()
                    {
                        if($(this).find(":checkbox").is(":checked"))
                            ...
                            para=para +"'" + $(this).find("td:eq(1)").find("input[type=text]").attr('value') + "','" + $(this).find("td:eq(3)").find("input[type=text]").attr('value') + "','" + Supervisor +  "','" + PlantCd +  "'" ;
...
<tr><td align="center" style="height: 53px"><h3><u>HAMALI ENTRY DELETION FORM</u></h3></td></tr>
</table>
...
<td style="width:2%"><h3><label>From Date</label></h3></td>
...
<td style="width:2%"><h3><label>To Date</label></h3></td>
...
<td align="left" Width="5%">
<asp:DropDownList ID="cmbPlant" runat="server" Width="80%" AutoPostBack="True">   
<asp:ListItem Value="0">Select</asp:ListItem>
</asp:DropDownList>
</td>

<td style="width:2%"><h3><label>Supervisor</label></h3></td>
<td align="left" Width="7%">
<asp:DropDownList ID="cmbSupervisor" runat="server" Width="70%" AppendDataBoundItems="True" AutoPostBack="True" > 
<asp:ListItem Value="0">Select</asp:ListItem>
        </asp:DropDownList>
