<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptHamaliBilling.aspx.vb" Inherits="rptHamaliBilling" %>
...
<%--''This code is used to cover the CSP Policy not implemented point (GIS / VAPT 2021 suggested) added this on 03-12-2021--%>
	...
	<%--''This code is used to cover the Referer Policy not implemented point (GIS / VAPT 2021 suggested) added this on 15-12-2021--%>
    <title>Hamali Billing Detail Report</title>
                                                        ...
                                                        //GetRadioButtonFlagType();
                                                         if (Diff[1]=='')
                                                            ...
                                                            //alert("i am in fifth option");
                                                               ...
                                                               ReportWindow.document.write('<h5>Hamali Billing Details : Billing Period:Fm  '+ document.getElementById("txtFrom").value + ' To ' + document.getElementById("txtTo").value +' <br /> </h5>')
...
<tr><td align="center" style="height: 53px"><h3><u>HAMALI BILLING REPORT</u></h3></td></tr>
</table>
