<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmHamaliApproval.aspx.vb" Inherits="frmHamaliApproval" %>
...
<table width="96%">
<tr>
<td style="width:20%"><h3><label>Supervisors List</label></h3></td>
<td>
<asp:DropDownList ID="cmbSupervisor" runat="server" Width="20%" AppendDataBoundItems="True" AutoPostBack="True">
<asp:ListItem Value="0">Select</asp:ListItem>
        </asp:DropDownList>
</td></tr>
</table>
 ...
 <div style="width:99%; overflow:auto">
  <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" OnRowDataBound = "OnRowDataBound" DataKeyNames = "supervisor_code" EmptyDataText="No Record Found">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Unp_Recd_Unl_Wt_Stk">
                <ItemTemplate>
                    ...
                    <asp:TextBox ID="txtUnp_Recd_Unl_Wt_Stk" runat="server" Text='<%# Eval("Unp_Recd_Unl_Wt_Stk") %>' Visible="true" BackColor="#FFFFD2" Width="250px" onkeypress="return NumberOnly()" maxlength="3" ></asp:TextBox>
                </ItemTemplate>
                <ItemStyle Width="250px" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Unp_Recd_Unl_Srt_Wt_Stk">
                <ItemTemplate>
                    ...
                    <asp:TextBox ID="txtUnp_Recd_Unl_Srt_Wt_Stk" runat="server" Text='<%# Eval("Unp_Recd_Unl_Srt_Wt_Stk") %>' Visible="true" BackColor="#FFFFD2" Width="250px" onkeypress="return NumberOnly()" maxlength="3" ></asp:TextBox>
                </ItemTemplate>
                <ItemStyle Width="150px" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Remark">
                <ItemTemplate>
                    ...
                    <asp:TextBox ID="txtRemark" runat="server" Text='<%# Eval("remark") %>' Visible="true" BackColor="#FFFFD2"></asp:TextBox>
                </ItemTemplate>
                <ItemStyle Width="150px" />
            </asp:TemplateField>
    ...
    <img id="imgsubmit" style="cursor:pointer;" class="vtip" title="Submit the data to Database." alt="Submit" src="img/Checklist/submit.png" onclick="javascript:validateCheckBoxes()" visible="false" /><asp:HiddenField
        ID="HiddenFieldSVID" runat="server" />
