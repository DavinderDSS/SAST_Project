<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptSupervisorWiseHamaliDtl.aspx.vb" Inherits="rptSupervisorWiseHamaliDtl" %>
...
<%--''This code is used to cover the CSP Policy not implemented point (GIS / VAPT 2021 suggested) added this on 03-12-2021--%>
	...
	<%--''This code is used to cover the Referer Policy not implemented point (GIS / VAPT 2021 suggested) added this on 15-12-2021--%>
    <title>Hamali Supervisor Wise Detail Report</title>
...
function Validation()
  ...
  function FillCombo(obj)
    {
        ...
        var Para=$(obj).attr("id") + "#" + code + "#" + FDt + "#" + TDt;
        //alert(Para);
        CallServer(Para,"");    
    }    
 ...
 function FillComboContractor(obj)
    {
 ...
 function FillComboDataContractor(data,obj)
 {
...
function ReceiveServerData(rValue)
                                                         ...
                                                         if (Diff[1]=='')
                                                        ...
                                                        else
                                                            {
                                                             ...
                                                             ReportWindow = window.open("", "subWind","toolbar=no,addressbar=no,resizable,scrollbars,modal=yes");
                                                               ...
                                                               var SupervisorNm = document.getElementById("cmbSupervisor");
                                                               var strSupervisorNm = SupervisorNm.options[SupervisorNm.selectedIndex].text;                                                              
                                                               var PlantNm = document.getElementById("cmbPlant");
                                                               var strPlant = PlantNm.options[PlantNm.selectedIndex].text;
                                                               var StatusNm = document.getElementById("cmbStatus");
                                                               var strStatus = StatusNm.options[StatusNm.selectedIndex].text;
                                                               ...
                                                               ReportWindow.document.write('<h5>Hamali Supervisor Wise Detail  : Period:Fm  '+ document.getElementById("txtFrom").value + ' To ' + document.getElementById("txtTo").value +' <br /> </h5>')
                                                               ReportWindow.document.write('<h5>Plant Detail:    '+ strPlant + '</h5>')
                                                               ReportWindow.document.write('<h5>Supervisor Detail:    '+ strSupervisorNm + '</h5>')
                                                               ReportWindow.document.write('<h5>Status Detail:    '+ strStatus + '</h5>')                                                               
    ...
    var cmbSupervisorVal= Diff[0]
     ...
     //New code for Filling values in text box if data is already present in Database 29-12-2012
			var cmbContractor=rValue.split("~")			
			var cmbContractorAllStr = cmbContractor[1].split("|")
			
             //New Code is added below on 7-12-2012
        
            var cmbContractorAllStrVal=cmbContractorAllStr[0].substring(0,13);
            var cmbContractorAllStrValDtl=cmbContractorAllStr[0];
            //alert(cmbContractorAllStrVal);
        switch(cmbContractorAllStrVal)
        	{
        			
				     case "cmbContractor":
                     //alert("i am in cmbA case");
				                    ClearCombo(cmbContractorAllStrValDtl);
				                    
				                    var ValueTextArray = cmbContractorAllStr[1].split(",");
				                    //alert(ValueTextArray);				                   
				                    FillComboDataContractor(ValueTextArray,cmbContractorAllStrValDtl);
				                    //LoadComplete();
				                    break
...
//				                                                     //FillComboDataContractor(ValueTextArray,cmbContractorVal);
                     ...
                     if (Page_ClientValidate())
                        {
                              ...
                              var FromDate = document.getElementById("txtFrom").value;
                                    ...
                                    var Supervisor = document.getElementById("cmbSupervisor").value;     
...
<tr><td align="center" style="height: 53px"><h3><u>HAMALI SUPERVISOR WISE DETAIL REPORT</u></h3></td></tr>
</table>
   ...
   <center>           
            <div class="demo">
                            <table width="80%" id="MyTable" border="1">
                                    ...
                                    <td align="left" style="width: 125px">
                                    <label for="to" style="font-size:larger">Supervisor</label> &nbsp;
                                    </td>
                                    <td align="left">
                                    <asp:DropDownList ID="cmbSupervisor" runat="server"  >   <%--Width="60%"--%>
			                        <asp:ListItem Value="0">Select</asp:ListItem>
			                        </asp:DropDownList>
			                        <asp:RequiredFieldValidator ID="ReqcmbSupervisor" runat="server" SetFocusOnError="true" ErrorMessage="Select Supervisor " ControlToValidate="cmbSupervisor" InitialValue="0"></asp:RequiredFieldValidator>                                                            
                                    </td>                                    
                                   </tr>
                                   <tr>
                                   <td align="left" style="width: 125px">
                                   ...
                                   <td align="left" style="width: 125px">
                                    <label for="to" style="font-size:larger">Status</label> &nbsp;
                                    </td>
                                    <td align="left">
                                    <asp:DropDownList ID="cmbStatus" runat="server"  >   <%--Width="60%"--%>
			                        <asp:ListItem Value="0">Select</asp:ListItem>
			                        </asp:DropDownList>
			                        <asp:RequiredFieldValidator ID="ReqcmbStatus" runat="server" SetFocusOnError="true" ErrorMessage="Select Status " ControlToValidate="cmbStatus" InitialValue="0"></asp:RequiredFieldValidator>                                                            
                                    </td>
                                   </tr>                                   
                                   <tr>
