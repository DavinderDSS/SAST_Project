...
Partial Class frmHamaliExecution
    ...
    Public Sub RaiseCallbackEvent(ByVal eventArgument As String) Implements System.Web.UI.ICallbackEventHandler.RaiseCallbackEvent
        ...
        Else
            Try
                ...
                ''Dim MtartGrpHALB As String = substring(matnr, 8, 1) = "B" Or substring(matnr, 8, 1) = "R" Or substring(matnr, 8, 1) = "S" Or substring(matnr, 8, 1) = "K" Or substring(matnr, 8, 1) = "Z" Or substring(matnr, 8, 1) = "J" Or substring(matnr, 8, 1) = "V" Or substring(matnr, 8, 1) = "D" Or substring(matnr, 8, 1) = "U" Or substring(matnr, 8, 1) = "M" Or substring(matnr, 8, 1) = "P"
